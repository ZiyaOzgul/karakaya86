...
function ProcessCard({ process, id }) {
  return (
    <Link to={`/process/${id}`}>
      <div className="w-44 h-80  flex flex-col items-start justify-start relative group hover:scale-110 ease-in-out duration-500">
        <img
          src={process.imgLink}
          alt=""
